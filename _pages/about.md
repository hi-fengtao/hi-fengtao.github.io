...
My research lies at the intersection of computer vision and machine learning. My research interests include **Computer Vision**, **Continual Learning**, **Video Generation** and **Vision-Language Model**. My vision is striving to build <u>Continual AI — intelligence that learns, adapts, and grows over time.</u>
